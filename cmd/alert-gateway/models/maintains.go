...
type Maintains struct {
	...
	Matchers  []*MaintainMatcher `orm:"reverse(many)" json:"matchers"`
}
...
type MaintainMatcher struct {
	Id       int64      `orm:"auto" json:"id,omitempty"`
	Maintain *Maintains `orm:"rel(fk)" json:"maintain"`
	Matcher  string     `orm:"size(255)" json:"matcher"`
}

func (*MaintainMatcher) TableName() string {
	return "maintain_matcher"
}
