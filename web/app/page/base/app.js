...
import Inhibit from "@content/inhibits";
import Silence from "@content/silence";
            ...
            <section id="content">
              ...
              <div id="main">
                <div id="main-box">
                  ...
                  <Route
                    exact
                    path={`${path}alerts_confirm`}
                    component={AlertsConfirm}
                  />
                  <Route
                    path={`${path}alerts_confirm/:id`}
                    component={AlertsConfirmByID}
                  />
                  <Route path={`${path}group`} component={Group} />
                  <Route path={`${path}user`} component={User} />
                  <Route path={`${path}inhibits`} component={Inhibit} />
                  <Route path={`${path}silence`} component={Silence} />
                </div>
              </div>
            </section>
          </div>
