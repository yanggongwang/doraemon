...
import { Button, Table, message, Popconfirm, Input, Icon, Tag } from "antd";
  ...
  getColumnSearchProps = (dataIndex) => ({
    ...
    onFilter: (value, record) => {
      ...
      switch (dataIndex) {
        ...
        case "prom_id":
          content = this.props.promethusLink
            ? this.props.promethusLink[record[dataIndex]] || record[dataIndex]
            : record[dataIndex];
          break;
        // eslint-disable-next-line camelcase
        case "plan_id":
          content = this.props.strategyLink
            ? this.props.strategyLink[record[dataIndex]] || record[dataIndex]
            : record[dataIndex];
          break;
        default:
  ...
  render() {
    ...
    const columns = [
      ...
      { title: "持续时间", align: "center", dataIndex: "for" },
      {
        ...
        render: (promId) => (
          <span>
            {this.props.promethusLink
              ? this.props.promethusLink[promId] || promId
              : promId}
          </span>
        ),
      },
      {
        ...
        render: (planId) => (
          <span>
            {this.props.strategyLink
              ? this.props.strategyLink[planId] || planId
              : planId}
          </span>
        ),
      },
